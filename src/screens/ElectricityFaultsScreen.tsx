...
const styles = StyleSheet.create({
  ...
  label: { fontSize: 16, fontWeight: '700', color: ELECTRIC_COLORS.textPrimary, textAlign: 'right', marginBottom: 12 },
  typeSelector: { flexDirection: 'row-reverse', flexWrap: 'wrap', gap: 8, marginBottom: 16 },
  typeBtn: { width: '48%', flexDirection: 'row-reverse', alignItems: 'center', justifyContent: 'center', gap: 6, backgroundColor: ELECTRIC_COLORS.surface, paddingVertical: 12, borderRadius: 12, borderWidth: 1, borderColor: '#E2E8F0' },
  ...
  imageTitle: { fontSize: 16, fontWeight: '700', color: ELECTRIC_COLORS.textPrimary, textAlign: 'right', marginBottom: 12 },
