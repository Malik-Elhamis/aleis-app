...
const styles = StyleSheet.create({
  ...
  title: { fontSize: 16, fontWeight: '700', color: COLORS.textPrimary, marginBottom: 4, textAlign: 'right' },
  date: { fontSize: 12, color: COLORS.textSecondary, textAlign: 'right' },
  ...
  actionBtn: { flex: 1, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', paddingVertical: 10, borderRadius: 8, backgroundColor: '#EEF2FF' },
