...
const styles = StyleSheet.create({
  ...
  headerSubtitle: { fontSize: 14, color: COLORS.textSecondary, textAlign: 'right', lineHeight: 22 },
  
  imageSection: { marginTop: 16, marginBottom: 24 },
  imageTitle: { fontSize: 16, fontWeight: '700', color: COLORS.textPrimary, textAlign: 'right', marginBottom: 12 },
