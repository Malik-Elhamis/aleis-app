...
const styles = StyleSheet.create({
  ...
  categoryTag: { flexDirection: 'row', alignItems: 'center', backgroundColor: '#FFE4E6', paddingHorizontal: 8, paddingVertical: 4, borderRadius: 8 },
  ...
  replyText: { fontSize: 14, color: '#7F1D1D', textAlign: 'left', lineHeight: 22 },
