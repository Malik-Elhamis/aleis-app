...
const styles = StyleSheet.create({
  ...
  personImage: { width: 44, height: 44, borderRadius: 22, marginLeft: 16, borderWidth: 1, borderColor: '#D1D5DB' },
  iconCircle: { width: 44, height: 44, borderRadius: 22, backgroundColor: '#374151', justifyContent: 'center', alignItems: 'center', marginLeft: 16 },
  nameContainer: { flex: 1 },
  nameLabel: { fontSize: 12, color: COLORS.textSecondary, textAlign: 'right', marginBottom: 4 },
  deceasedName: { fontSize: 18, fontWeight: '800', color: COLORS.textPrimary, textAlign: 'right' },
  
  detailsBox: { backgroundColor: '#F3F4F6', borderRadius: 12, padding: 16, gap: 12 },
  detailRow: { flexDirection: 'row-reverse', alignItems: 'flex-start', gap: 12 },
  detailText: { fontSize: 14, color: COLORS.textPrimary, textAlign: 'right', flex: 1, lineHeight: 22 },
